...
stacking_model = GridCVWrapper(Ridge, seed=SEED, cv_fold=5, params={}, scoring=R2, param_grid = {
...
stacking_model=stacking_model, stacking_with_pre_features=False, n_folds=10, random_seed=0)
